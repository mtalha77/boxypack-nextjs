...
const ProductByMaterialCarousel: React.FC = () => {
  ...
  return (
    <section id="product-by-material" className="py-24 bg-white">
      <div className="w-full">
        {/* Header Section */}
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center lg:text-left mb-12">
            <div className="inline-flex items-center border-2 border-brown-dark2 px-6 py-3 bg-white rounded-full text-brown-dark2 text-sm font-semibold mb-6 shadow-lg">
            ...
            <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between">
              <p className="text-body-large text-body-primary max-w-3xl mx-auto lg:mx-0 leading-relaxed mb-8 lg:mb-0">
                Packaging boxes crafted from durable materials are designed to
                give your products strength, beauty, and your brand’s unique
                identity.
              </p>
              ...
              {productByMaterialData.map((category, cardIndex) => (
                ...
                <Link href={`/products/product-by-material/${category.slug}`}>
                  <CldImage
                    ...
                    width={400}
                    height={400}
                    className="w-full h-96 sm:h-[400px] md:h-80 object-cover rounded-t-lg"
                  />
                </Link>
                <div className="p-5">
                  <Link href={`/products/product-by-material/${category.slug}`}>
