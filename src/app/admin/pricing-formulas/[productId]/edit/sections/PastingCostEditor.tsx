...
import { ProductPricingFormula, PastingCostFormula } from '@/lib/types/pricing-formulas';

interface Props {
  formula: ProductPricingFormula;
  onUpdate: (data: PastingCostFormula) => void;
}

export default function PastingCostEditor({ formula, onUpdate }: Props) {
  const [costPer1000, setCostPer1000] = useState(formula.pastingCost.costPer1000);
    ...
    <div className="space-y-6 text-gray-900">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        ...
        <p className="text-blue-800 text-sm mb-2">
          Pasting cost is calculated per 1000 units. The multiplier increases with quantity:
        </p>
      ...
      <div className="bg-gray-100 rounded-lg p-4">
        ...
        <code className="text-sm text-gray-900 block">
          Pasting Cost = ${costPer1000} × ceil(Required Units / 1000)
        </code>
      </div>
