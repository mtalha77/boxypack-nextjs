...
export const navigationData: NavigationSection[] = [
    ...
    categories: [
      {
        name: 'Rigid Boxes',
        slug: 'rigid-boxes',
        description: 'Premium luxury packaging with superior strength',
        subcategories: [
      ...
      },
      {
        name: 'Kraft Boxes',
        slug: 'kraft-boxes',
        description: 'Eco-friendly kraft paper packaging solutions',
        subcategories: [
      ...
      },
      {
        ...
        description: 'Versatile cardboard packaging for all industries',
        subcategories: [
      ...
      },
      {
        ...
        description: 'Strong corrugated packaging for shipping and storage',
        subcategories: [
    ...
    categories: [
      {
        name: 'Bakery Boxes',
        slug: 'bakery-boxes',
        description: 'Specialized packaging for bakery and confectionery items',
        subcategories: [
      ...
      },
      {
        name: 'Food Boxes',
        slug: 'food-boxes',
        description: 'Food-safe packaging for restaurants and food businesses',
        subcategories: [
      ...
      },
      {
        name: 'Gift Boxes',
        slug: 'gift-boxes',
        description: 'Elegant gift packaging for special occasions',
        subcategories: [
      ...
      },
      {
        name: 'Retail Boxes',
        slug: 'retail-boxes',
        description: 'Professional retail packaging solutions',
        subcategories: [
      ...
      },
      {
        name: 'Candle Boxes',
        slug: 'candle-boxes',
        description: 'Protective and attractive candle packaging',
        subcategories: [
      ...
      },
      {
        ...
        description: 'Reliable shipping solutions for e-commerce',
        subcategories: [
      ...
      },
      {
        ...
        description: 'Specialized packaging for soap and bath products',
        subcategories: [
      ...
      },
      {
        name: 'Apparel Boxes',
        slug: 'apparel-boxes',
        description: 'Professional packaging for clothing and accessories',
        subcategories: [
      ...
      },
      {
        name: 'Sports Boxes',
        slug: 'sports-boxes',
        description: 'Packaging solutions for sports and athletic products',
        subcategories: [
      ...
      },
      {
        ...
        description: 'Specialized packaging for tobacco products',
        subcategories: [
      ...
      },
      {
        name: 'CBD Boxes',
        slug: 'cbd-boxes',
        description: 'Compliant packaging for CBD and cannabis products',
        subcategories: [
      ...
      },
      {
        name: 'E-liquid Boxes',
        slug: 'e-liquid-boxes',
        description: 'Specialized packaging for vaping products',
        subcategories: [
      ...
      },
      {
        ...
        description: 'Professional packaging for office and school supplies',
        subcategories: [
      ...
      },
      {
        ...
        description: 'Festive packaging for holiday celebrations',
        subcategories: [
      ...
      },
      {
        ...
        description: 'Premium packaging for chocolate and confectionery',
        subcategories: [
      ...
      },
      {
        name: 'Cereal Boxes',
        slug: 'cereal-boxes',
        description: 'Custom packaging for breakfast cereals and grains',
        subcategories: [
      ...
      },
      {
        ...
        description: 'Specialized packaging for pre-rolled cannabis products',
        subcategories: [
      ...
      },
      {
        name: 'Pizza Boxes',
        slug: 'pizza-boxes',
        description: 'Food-safe packaging for pizza and Italian cuisine',
        subcategories: [
  ...
  },
  {
    ...
    subcategories: [
      { name: 'Stand Up Zip Lock Mylar Bags', slug: 'stand-up-zip-lock-mylar-bags' },
      { name: 'Mylar Ziplock Bags', slug: 'mylar-ziplock-bags' }
    ]
  },
  {
    name: 'Shopping Bags',
    ...
    subcategories: [
      { name: 'Kraft Shopping Bag', slug: 'kraft-shopping-bag' },
      { name: 'Paper Bag', slug: 'paper-bag' },
      { name: 'PVC Bag', slug: 'pvc-bag' }
    ]
  },
  {
    name: 'Other',
    ...
    subcategories: [
      ...
      { name: 'Tags Printing', slug: 'tags-printing' },
      ...
      { name: 'Product Labels & Bottle Labels', slug: 'product-labels-bottle-labels' },
