...
export const metadata: Metadata = {
  ...
  description: 'Premium e-liquid bottle box packaging solutions with leak-proof designs. Custom specialized packaging designed for optimal protection and presentation.',
  keywords: 'e-liquid bottle boxes, custom packaging, leak-proof packaging, e-liquid packaging',
};
