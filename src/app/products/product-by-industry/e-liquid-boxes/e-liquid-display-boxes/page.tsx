...
export const metadata: Metadata = {
  ...
  description: 'Premium e-liquid display box packaging solutions with leak-proof designs. Custom specialized packaging designed for optimal protection and presentation.',
  keywords: 'e-liquid display boxes, custom packaging, leak-proof packaging, e-liquid packaging',
};
